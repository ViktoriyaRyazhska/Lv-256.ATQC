...
public class RegistratorHomePage extends DropdownHomePage {
	...
	public WebElement resourcesSearch;
	public WebElement subclassesOfObjects;
	public WebElement procuration;
	public WebElement addNewResource;
	public WebElement procurationEnteringData;
	public WebElement procurationExtractFromRegister;

	public RegistratorHomePage(WebDriver driver) {
		super(driver);
		resourcesSearch = driver.findElement(By.cssSelector(".dropdown>a"));
		subclassesOfObjects = driver.findElement(By.cssSelector("[href $= 'show-res-types']"));
