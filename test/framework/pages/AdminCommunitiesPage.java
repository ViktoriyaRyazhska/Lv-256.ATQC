...
public class AdminCommunitiesPage extends AdminHomePage {
	private static WebElement addNewCommunityButton;
	private static WebElement communitiesLabel;
	private WebElement inactiveCheckbox;
	private WebElement inactiveCheckboxLabel;
	private WebElement tableWithCommunities;
	private static WebElement territorialCommunityHeader;
	...
	public static WebElement getTerritorialCommunityHeader() {
	...
	public static String getAddNewCommunityButtonText() {
		return addNewCommunityButton.getText().trim();
	}

	public static String getCommunitiesLabelText() {
