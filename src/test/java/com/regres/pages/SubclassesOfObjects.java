...
public class SubclassesOfObjects extends RegistratorHomePage {
	...
	private WebElement nameSubclassDB;
	...
	String NAME_SUBCLASS_DB_XPATH = "//td[contains(., 'Lviv')]";
	...
	public WebElement getNameSubclassDB() {
		nameSubclassDB = driver.findElement(By.xpath(NAME_SUBCLASS_DB_XPATH));
		return nameSubclassDB;
	}
