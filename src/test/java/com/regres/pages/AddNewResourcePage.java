...
public class AddNewResourcePage {
	...
	public AddNewResourcePage(WebDriver driver) {
		this.driver = driver;
		selectCoowner = driver.findElement(By.id(SELECT_COOWNER_INPUTFIELD_ID));
		objectName = driver.findElement(By.id(OBJECT_NAME_INPUTFIELD_ID));
		objectSubclass = driver.findElement(By.id(OBJECT_SUBCLASS_DROPDOWN_ID));
		registrNumbOfObject = driver.findElement(By.id(REGISTRNUMB_OBJ_ID));
		edit = driver.findElement(By.id(EDIT_BUTTON_ID));
		reasonForInclusion = driver.findElement(By.id(REASON_FOR_INCLUSION_ID));
		procurations = driver.findElement(By.id(PROCURATIONS_CHECKBOX_ID));
		data = driver.findElement(By.id(DATE_ID));
		...
		// closeButton=driver.findElement(By.id());
		save = driver.findElement(By.id(SAVE_BUTTON_ID));
		clear = driver.findElement(By.id(CLEAR_FORM_BUTTON_ID));
		resourceActsUkr = driver.findElement(By.id(RESORCE_ACTS_UKRAINE_ID));
