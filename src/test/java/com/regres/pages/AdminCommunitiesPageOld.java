...
public class AdminCommunitiesPageOld extends AdminHomePage {
	WebDriverWait wait;
	Properties property;
	...
	public AdminCommunitiesPageOld(WebDriver driver) {
		super(driver);
	}
	...
	public AdminCommunitiesPageOld deleteCommunity(String communityName) {
	 ...
	 */
	@Override
	public AdminCommunitiesPageOld setLanguage(ChangeLanguageFields language) {
