...
public class SearchInTable {
	...
	// List<UserForSerchTableTest> userList1 =
	// coownerstable.searchByTerritorialCommunityName("Ukr");
	// coownerstable.setCOMMUNITY_SEARCHN("Ukr");
	// coownerstable.getSearchButton().click();
	// List<UserForSerchTableTest> userList2 =
	// coownerstable.getListOfUsersFromTable();
	// coownerstable.compareLists(userList1, userList2);
	// }
	//
	// //@Test
