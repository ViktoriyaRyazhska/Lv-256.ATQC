...
public enum HTTPError {
	...
	public HTTPError setValue(int value) {
		...
		case 414: return HTTPError.HTTP414;
		case 415: return HTTPError.HTTP415;
		case 416: return HTTPError.HTTP416;
		case 417: return HTTPError.HTTP417;
		case 418: return HTTPError.HTTP418;
		case 419: return HTTPError.HTTP419;
		case 420: return HTTPError.HTTP420;
		case 422: return HTTPError.HTTP422;
		case 423: return HTTPError.HTTP423;
		case 424: return HTTPError.HTTP424;
		case 428: return HTTPError.HTTP428;
		case 429: return HTTPError.HTTP429;
		case 431: return HTTPError.HTTP431;
		case 440: return HTTPError.HTTP440;
		case 444: return HTTPError.HTTP444;
		case 449: return HTTPError.HTTP449;
		case 450: return HTTPError.HTTP450;
		case 451: return HTTPError.HTTP451;
